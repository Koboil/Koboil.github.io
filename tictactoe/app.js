...
const verifiedVictory = () => {
	if (
		//On vérifie toute les win conditions
		...
		//ici on vérifie on regarde si toutes les cases sont pleine sans victoire et si c'est le cas
		...
		// alors la partie n'est pas encore terminée
		return false;
	}
};
